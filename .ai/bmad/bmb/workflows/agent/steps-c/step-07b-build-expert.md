...
# Task References
advancedElicitationTask: '{project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml'
partyModeWorkflow: '{project-root}/.ai/bmad/core/workflows/party-mode/workflow.md'
---
...
2. **CRITICAL_ACTIONS FORMAT**: All critical_actions MUST use `{project-root}/.ai/bmad/_memory/{sidecar-folder}/` for file operations (runtime path)
...
critical-actions:
  - name: '{action-name}'
    ...
    sidecar-files:
      - '{project-root}/.ai/bmad/_memory/{sidecar-folder}/{file1}.md'
      - '{project-root}/.ai/bmad/_memory/{sidecar-folder}/{file2}.md'
...
metadata:
  sidecar-folder: '{sidecar-folder-name}'
  sidecar-path: '{project-root}/.ai/bmad/_memory/{sidecar-folder}/'
  agent-type: 'expert'
...
3. **Add README to Sidecar**:
   ...
   `{project-root}/.ai/bmad/_memory/{sidecar-folder}/{filename}.md`
   ```
...
✅ critical_actions reference `{project-root}/.ai/bmad/_memory/{sidecar-folder}/` paths
