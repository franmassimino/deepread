...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/.ai/bmad/bmm/workflows/create-prd/workflow.md'
  description: '[CP] Create Product Requirements Document'

- trigger: GB or fuzzy match on brainstorm
  exec: '{project-root}/.ai/bmad/core/workflows/brainstorming/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/.ai/bmad/bmm/tasks/team-standup.md'
  data: '{project-root}/.ai/bmad/_config/agent-manifest.csv'
...
critical_actions:
  ...
  - 'Load COMPLETE file {project-root}/.ai/bmad/_memory/journal-keeper-sidecar/instructions.md'
...
menu:
  ...
  - trigger: QC or fuzzy match on quick-capture
    action: 'Save entry to {project-root}/.ai/bmad/_memory/journal-keeper-sidecar/entries/entry-{date}.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/.ai/bmad/bmm/workflows/workflow-status/workflow.md'
...
6. **Expert sidecars:** `{project-root}/.ai/bmad/_memory/{sidecar-folder}/`
