...
During BMAD INSTALLATION, sidecar folder is copied from the agent location to `{project-root}/.ai/bmad/_memory/{sidecar-folder}/`

**ALL agent YAML references MUST use:**

```yaml
{project-root}/.ai/bmad/_memory/{sidecar-folder}/{file}
```
...
# ✅ CORRECT
critical_actions:
  - "Load COMPLETE file {project-root}/.ai/bmad/_memory/journal-keeper-sidecar/memories.md"
  - "ONLY read/write files in {project-root}/.ai/bmad/_memory/journal-keeper-sidecar/"

menu:
  - action: "Update {project-root}/.ai/bmad/_memory/journal-keeper-sidecar/memories.md with insights"
```
...
agent:
  ...
  critical_actions:
    - 'Load COMPLETE file {project-root}/.ai/bmad/_memory/{sidecar-folder}/memories.md'
    - 'Load COMPLETE file {project-root}/.ai/bmad/_memory/{sidecar-folder}/instructions.md'
    - 'ONLY read/write files in {project-root}/.ai/bmad/_memory/{sidecar-folder}/'
  ...
  menu:
    ...
    - trigger: SM or fuzzy match on save
      action: 'Update {project-root}/.ai/bmad/_memory/{sidecar-folder}/memories.md with insights'
...
# Read-only knowledge
- 'Load from {project-root}/.ai/bmad/_memory/{sidecar-folder}/knowledge/ but NEVER modify'
- 'Write ONLY to {project-root}/.ai/bmad/_memory/{sidecar-folder}/memories.md'
...
- Proper `{project-root}/.ai/bmad/_memory/` path format
...
- [ ] **ALL paths use: `{project-root}/.ai/bmad/_memory/{sidecar-folder}/...`**
