...
- IF A: Execute {project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml
- IF P: Execute {project-root}/.ai/bmad/core/workflows/party-mode/workflow.md
