...
- Execute {project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml with specific decision categories
...
- Execute {project-root}/.ai/bmad/core/workflows/party-mode/workflow.md with architectural decisions context
