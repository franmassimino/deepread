...
- Execute {project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml with the current visual foundation content
...
- Execute {project-root}/.ai/bmad/core/workflows/party-mode/workflow.md with the current visual foundation
