...
workflow_path: '{project-root}/.ai/bmad/bmm/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/.ai/bmad/core/tasks/review-adversarial-general.xml</invoke-task>
```
