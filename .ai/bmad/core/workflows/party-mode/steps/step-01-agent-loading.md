...
- Agent manifest CSV is available at `{project-root}/.ai/bmad/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/.ai/bmad/_config/agent-manifest.csv`
