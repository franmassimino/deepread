...
helpers: '{project-root}/.ai/bmad/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/.ai/bmad/core/resources/excalidraw/validate-json-instructions.md'
```
