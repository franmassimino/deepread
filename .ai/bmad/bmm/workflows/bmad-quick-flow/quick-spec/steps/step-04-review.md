...
workflow_path: '{project-root}/.ai/bmad/bmm/workflows/bmad-quick-flow/quick-spec'
...
- **[r]**: Execute Adversarial Review:
    1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/.ai/bmad/core/tasks/review-adversarial-general.xml</invoke-task>
