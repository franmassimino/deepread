...
- [Epic 2 Story 2.6 Requirements](../../../docs/bmad-output/planning-artifacts/epics.md#story-26-delete-book-from-library)
...
- docs/bmad-output/implementation-artifacts/epic-02/story-2.6-delete-book-from-library.md
- docs/bmad-output/implementation-artifacts/sprint-status.yaml
