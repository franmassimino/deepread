...
- Use `{project-root}/.ai/bmad/_memory/{sidecar-folder}/` format for RUNTIME paths in agent YAML
...
| Type | Pattern |
|------|---------|
| Expert sidecar | `{project-root}/.ai/bmad/_memory/{sidecar-folder}/file.md` |
