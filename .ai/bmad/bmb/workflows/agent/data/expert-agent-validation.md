...
- [ ] **Loads sidecar memories:** `{project-root}/.ai/bmad/_memory/{sidecar-folder}/memories.md`
- [ ] **Loads sidecar instructions:** `{project-root}/.ai/bmad/_memory/{sidecar-folder}/instructions.md`
- [ ] **Restricts file access:** `ONLY read/write files in {project-root}/.ai/bmad/_memory/{sidecar-folder}/`
...
- [ ] ALL sidecar paths use: `{project-root}/.ai/bmad/_memory/{sidecar-folder}/...`
...
- [ ] References from agent YAML to sidecar use `{project-root}/.ai/bmad/_memory/` format
...
**Fix:** `{project-root}/.ai/bmad/_memory/journal-keeper-sidecar/memories.md`
