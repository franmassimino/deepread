...
- Execute {project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Execute {project-root}/.ai/bmad/core/workflows/party-mode/workflow.md with the current project context
