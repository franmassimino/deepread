...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on dev-story" workflow="{project-root}/.ai/bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml">[DS] Execute Dev Story workflow (full BMM path with sprint-status)</item>
