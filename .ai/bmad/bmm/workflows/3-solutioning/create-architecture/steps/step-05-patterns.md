...
- Execute {project-root}/.ai/bmad/core/workflows/advanced-elicitation/workflow.xml with current patterns
...
- Execute {project-root}/.ai/bmad/core/workflows/party-mode/workflow.md with implementation patterns context
